import { useServerStatus, ServerStatus } from '../context/ServerStatusContext.jsx';
        ...
        {isError ? (
          <>
            ...
            <p className="mb-6 text-sm text-gray-500">
              Le serveur ne répond pas après plusieurs tentatives. Veuillez réessayer dans un instant.
            </p>
            <button
              onClick={dismiss}
          ...
          <>
            ...
            <p className="text-sm text-gray-500">
              Le serveur est en train de se réveiller, veuillez patienter.
            </p>
            <p className="mt-1 text-xs text-gray-400">
              Les serveurs gratuits peuvent prendre ~30s à démarrer.
            </p>
          </>
        )}
      </div>
