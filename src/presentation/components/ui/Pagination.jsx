    ...
    <div className="flex flex-col items-center justify-between gap-3 px-1 py-3 sm:flex-row">
        ...
        {onLimitChange && (
          <label className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-md border-0 bg-white px-2 py-1 text-sm ring-1 ring-slate-300 focus:ring-2 focus:ring-indigo-600"
            >
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={page <= 1}
          className="inline-flex items-center rounded-md p-1.5 text-slate-600 ring-1 ring-slate-300 hover:bg-slate-50 disabled:opacity-40 disabled:hover:bg-transparent"
